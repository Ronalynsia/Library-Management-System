...
if ($_SERVER['REQUEST_ METHOD'] == 'POST' && isset($_POST[ 'add_student'] )){
...
if ($_SERVER ['REQUEST_ METHOD'] == 'POST' && isset ($_POST[' edit _student'])) {
$id = $_POST['edit_id'];
...
if ($_SERVER['REQUEST_ METHOD'] == 'POST' && isset ($_POST['delete_student'])) {
...
<td><?php echo htmlspecialchars ($student ['last_name']); ?></td>
        <td>
        <button onclick="shoeEditForm (<?php echo
$student['student_id']; ?>)">Edit</button>
        <button onclick=" confirmDelete (<?php echo
$student['student_id']; ?>)">Delete</button>
                </td>
            </tr>   
        <?php endwhile ; ?> 
    </tbody>
...
<div id="add-student-modal" class="modal">
    <form method=" POST" >
        ...
        <input type="text" id="student-id" name="student_ id" required> <br>
...
<div id=" edit-student-modal " class="modal">
    ...
    <input type="text" id="edit-first-name" name="edit_first_name"
required><br>
    <label for="edit- last-name">Last Name:</label>
    <input type="text" id="edit-last -name" name="edit_last_name"
required><br>
